...
public class FormEmployee extends javax.swing.JPanel {
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        try {    
            JRBeanCollectionDataSource jRBeanCollectionDataSource = new JRBeanCollectionDataSource(employeeService.getAllEmployees());
            String source = System.getProperty("user.dir") + "/src/report/EmployeeReport.jrxml";
